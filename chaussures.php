...
<div class="header" >
    ...
    <?php  if(isset($_SESSION['panier']) && is_array($_SESSION['panier'][3]))   {
          ...
          print' <a href="Panier.php" style="text-decoration:none;width: 0px;height:20px"><img src="images/cart.png" style="width: 40px;height: 30px;"><h6 style="width: 10px;height: 30px;">(0)</h6></a>';
      }?>
        </nav>
    </div>
...
<?php 
                foreach($chaussures as $c){
                     print ' 
        <div class="" style="width:280px;margin-left:60px;">
            <img width="200px" height="200px" src="images/'.$c['image'].'" class="card-img-top" alt="..." >
            <div class="card-body">
                 <h5 class="card-title" style="color:#ffc107;font-size:25px;text-align:center;">'.$c['nom'].'</h5>
                  <p class="card-text" style="color:blue;font-size:25px;text-align:center;">'.$c['description'].'</p>
                  <a href="Description_Produit.php?id='.$c['id'].'" class="btn" type="submit" id="btn-contact-form2">Ajouter au panier</a>
           </div>
       </div>
    ';
                 }
