...
if(!isset($_SESSION['user_name'])){
  ...
  include "includes/functions.php";
   ...
   if (!empty($_POST)){
    $vetements = searchVetement($_POST['search']);
   }else{
     $vetements = produitVetement();
...
<?php 
        ...
        <div class="" style="width:280px;margin-left:60px;">
            <img width="200px" height="200px" src="images/'.$vetement['image'].'" class="card-img-top" alt="..." >
            <div class="card-body">
                 <h5 class="card-title" style="color:#ffc107;font-size:25px;text-align:center;">'.$vetement['nom'].'</h5>
                  <p class="card-text" style="color:blue;font-size:25px;text-align:center;">'.$vetement['description'].'</p>
                  <a href="Description_Produit.php?id='.$vetement['id'].'" class="btn" type="submit" id="btn-contact-form2">Ajouter au panier</a>
           </div>
       </div>
    ';
                 }
